...
- [ ] Task 1: Create Sidebar Component Structure (AC: 1, 4, 7)
  - [ ] Create `src/components/Sidebar/ConceptList.tsx` component file
  - [ ] Set up MUI Drawer component with permanent/temporary variants
  - [ ] Configure drawer width (280px) and responsive behavior
  - [ ] Add proper TypeScript interfaces for component props
  
- [ ] Task 2: Implement Chapter Header Section (AC: 5)
  - [ ] Create chapter header sub-component with chapter number and title
  - [ ] Add progress calculation logic (completed/total concepts)
  - [ ] Style header with MUI Typography and Box components
  - [ ] Add visual separator between header and concept list
  
- [ ] Task 3: Build Concept List with Status Indicators (AC: 2, 6)
  - [ ] Use MUI List and ListItem components for concept list
  - [ ] Display concept number and title for each item
  - [ ] Add checkmark icon (CheckCircleIcon) for completed concepts
  - [ ] Add lock icon (LockIcon) for premium concepts
  - [ ] Style active/selected concept with highlighted background
  
- [ ] Task 4: Implement Navigation Logic (AC: 3)
  - [ ] Use Next.js router for client-side navigation
  - [ ] Navigate to `/concepts/{slug}` on concept click
  - [ ] Update active state based on current route
  - [ ] Prevent page reload using Link component or router.push
  
- [ ] Task 5: Add Responsive Behavior (AC: 4)
  - [ ] Implement useMediaQuery hook for breakpoint detection (960px)
  - [ ] Show permanent drawer on desktop (≥960px)
  - [ ] Show temporary drawer on mobile (<960px)
  - [ ] Add drawer state management (open/closed)
  - [ ] Integrate with MainLayout hamburger menu toggle
  
- [ ] Task 6: Fetch and Display Data from API (AC: 1)
  - [ ] Create data fetching hook or function
  - [ ] Call `GET /api/chapters/{id}/concepts` endpoint
...
- [ ] Task 8: Add Unit Tests
  ...
  - [ ] Test navigation on concept click
  - [ ] Test active state highlighting
  - [ ] Test completion indicator display
  - [ ] Test premium concept lock icon display
