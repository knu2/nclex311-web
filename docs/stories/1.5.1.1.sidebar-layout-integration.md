...
**Files Modified:**
- `apps/web/src/components/Sidebar/ConceptList.tsx` (lines 66-161)
- `apps/web/__tests__/components/Sidebar/ConceptList.test.tsx` (footer test sections)

**Test Results:** All 15 Sidebar Footer Tests passing (15/15) ✅

**Reference:** This fix follows the same pattern as BUG-AUTH-BLANK-PAGE (docs/stories/BUG-AUTH-BLANK-PAGE.md) which resolved similar authentication redirect issues with middleware and Next.js navigation.
...
| 2025-10-16 | 2.1 | Fixed sidebar footer navigation redirect issue (similar to BUG-AUTH-BLANK-PAGE) | James (Dev) |
